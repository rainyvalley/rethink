...
| F3M2CYK\_\_                                      | (model name unknown), Front-Load Washing Machine | 🫤 preliminary support: phase, time, course, tub-clean count |
...
| RV13D5JSD_D_US       | (model name unknown), Electric Dryer | 🫤 preliminary support: running, last-cycle settings |
